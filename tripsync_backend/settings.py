...
SECRET_KEY = 'django-insecure-tripsync-live-production-secret-key'
...
ROOT_URLCONF = 'tripsync_backend.urls'
...
WSGI_APPLICATION = 'tripsync_backend.wsgi.application'
...
# CORS & CSRF Settings for Live Vercel Domain
